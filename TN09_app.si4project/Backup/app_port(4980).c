...
{
//    GPIOA_ModeCfg(ROLL_PIN, GPIO_ModeIN_Floating);
//    GPIOA_ITModeCfg(ROLL_PIN, GPIO_ITMode_RiseEdge);
...
//        mir3da_set_enable(1);
//
//        GPIOA_ModeCfg(GSINT_PIN, GPIO_ModeIN_PU);
//        GPIOA_ITModeCfg(GSINT_PIN, GPIO_ITMode_FallEdge);
//        PFIC_EnableIRQ(GPIO_A_IRQn);
//    }
//    else
//    {
